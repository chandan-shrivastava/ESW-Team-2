...
if __name__ == "__main__":
    server = "http://192.168.81.246:8080"

    cse = "/~/in-cse/in-name/"

    delete(server + cse + "Team-36")
    create_ae(server + cse, "Team-36")
    create_cnt(server + cse + "Team-36/","Water-Cooler")
    create_cnt(server + cse + "Team-36/Water-Cooler","Nilgiri-1")
    create_cnt(server + cse + "Team-36/Water-Cooler","Nilgiri-2")
    create_cnt(server + cse + "Team-36/Water-Cooler","Nilgiri-3")
    # create_cnt(server + cse + "Team-2/Node-1/", "Data", "team2")
    # create_data_cin(server + cse + "Team-36/Water-Cooler/", "[x y time]","team36")
